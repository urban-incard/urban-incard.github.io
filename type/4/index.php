                ...
                <div class="section">
                    <div class="main" style="width:320px;text-align:center;position:absolute;top:50%;left:50%;">
						...
						<div style="padding:20px;">
							<img src="images/==IMAGE_FIRST==" onError="this.src='main22.jpg';" style="border-radius:50%;width:160px;height:160px;" />
						</div>
						<div style="padding:20px;">
                ...
                <div class="section map">
					<div class="intro" style="width:320px;height:416px;text-align:center;position:absolute;top:50%;left:50%;">
						<div>
							...
							<div id="map" onclick="window.open('https://map.kakao.com/?map_type=TYPE_MAP&q=라온스퀘어&urlLevel=6')" style="filter: hue-rotate(125deg);"></div>
